...
//                         onclick={() => handlePurchase(stripePromise, useElements())}
//                 >
...
const stripePromise = loadStripe(env.get("STRIPE_PUBLIC_KEY"));
...
export function ProductInfo({ product }: Props) {
    const handlePurchase = async () => {
        try {
            ...
            console.error('Erreur lors de la création de l\'intention de paiement :', error);
            // Gérer l'erreur liée à l'appel API ou autre
        }
    };
